...
>
  <span class="text-warning block w-min mx-auto" style="font-size: 3rem;">
  ...
  <p class="small"><span class="text-warning fs-5">¿Tienes dudas?</span> <br> <br> Puedes ver el Folleto del <i class="fw-bold">Programa de Fidelización</i> dando click en el siguiente botón:</p>
  <a
