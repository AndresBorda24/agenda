<footer class="bg-neutral-100 overflow-hidden small">
  <div class="grid grid-cols-1 lg:grid-cols-2 max-w-7xl mx-auto py-20 px-7 gap-7">
    <div class="flex flex-col max-w-lg gap-6">
      ...
      <div class="flex gap-6 items-center">
        <a
          class="text-decoration-none text-sky-900 hover:text-sky-950 [&>svg]:w-6 [&>svg]:h-6"
  ...
  <div class="text-sky-800 flex flex-col lg:flex-row flex-wrap !gap-4 lg:!gap-7 px-7 justify-center py-7 bg-neutral-200 text-sm">
    <span class="flex !gap-2 items-center">
      <span class="text-sky-900 [&>svg]:w-6 [&>svg]:h-6"><?= $this->fetch("./icons/location.php") ?></span>
      Cra. 4D No. 32 - 34 , Ibagu&eacute;, Tolima
    </span>
    <span class="flex !gap-2 items-center">
      <span class="text-sky-900 [&>svg]:w-6 [&>svg]:h-6"><?= $this->fetch("./icons/mail.php") ?></span>
      <a
        class="text-decoration-none text-sky-900"
        href="mailto:gerencia@asotrauma.com.co"
      > gerencia@asotrauma.com.co </a>
    </span>
    <span class="flex !gap-2 items-center">
      <span class="text-sky-900 [&>svg]:w-6 [&>svg]:h-6"><?= $this->fetch("./icons/phone.php") ?></span>
      (8) 515 - 3000
    </span>
  </div>

  <div class="bg-sky-900 px-2 py-3 text-center text-white small">
